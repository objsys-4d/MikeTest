...
// BackgroundApi_FindFirstNameList (firstname_list, iso3_country_code) : search_result_list
//
// DESCRIPTION
//   Invokes Background's findFirstName api and returns
//   the result from a first name search.
//   
//   An empty result indicates that something went wrong.
//
#DECLARE($firstname_list : Collection; $iso3_country_code : Text)->$search_result_list : Collection
// ----------------------------------------------------
$search_result_list:=New collection:C1472()

var $url : Text
$url:=Storage:C1525.background.url+"/api/v1/findListOfFirstNames"

var $content : Object
$content:=New object:C1471
$content.country_iso3:=$iso3_country_code
$content.firstname_list:=$firstname_list
