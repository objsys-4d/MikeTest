...
#DECLARE($country_code : Text; $delete_first : Boolean)->$stats : Object
...
End if 
$country:=ds:C1482.country.get($country_code)
...
If (Find in array:C230($atTables; $table_name)=-1)
	...
	//C_TEXT($sql)
	//$sql:=“ALTER TABLE “+$table_name+” ADD “+$field_name+” “+$field_sql_type+“; ”
	//Begin SQL
