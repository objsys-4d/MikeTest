...
// BackgroundApi_FindFirstName (firstname, iso3_country_code) : search_result
//
// DESCRIPTION
...
//
#DECLARE($firstname : Text; $iso3_country_code : Text)->$search_result : Object
// ----------------------------------------------------
$search_result:=New object:C1471

var $url : Text
$url:=Storage:C1525.background.url+"/api/v1/findFirstName"
